    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-col items-center justify-center text-center px-16 max-w-4xl w-full">
        ...
        <p className="text-2xl text-zinc-600 dark:text-zinc-400 mb-12">
          Create tutorials using the new workflow architecture
        </p>
        ...
        <div className="w-full max-w-2xl space-y-4">
          ...
          <div className="flex flex-col gap-2">
            <label
              ...
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300 text-left"
            >
              Course Slug (optional, will use from JSON if provided):
            </label>
            <input
              id="course-slug"
              type="text"
          ...
          <div className="flex flex-col gap-2">
            <label
              ...
              className="text-sm font-medium text-zinc-700 dark:text-zinc-300 text-left"
            >
              Syllabus JSON (optional, will use sample if empty):
            </label>
            <textarea
              id="syllabus-json"
              value={syllabusJson}
          ...
          <button
            ...
            disabled={loading || !rigoToken || !bcToken}
          ...
          >
            {loading ? "Creating Tutorial..." : "Create Tutorial"}
          </button>
